package hudson.plugins.checkstyle.csslint.parser;
 ...
 */
public class CSSLintCheckStyleParser extends AbstractAnnotationParser {
    /** Unique identifier of this class. */
    private static final long serialVersionUID = 1L;

    /**
     * Creates a new instance of {@link CSSLintCheckStyleParser}.
     */
    public CSSLintCheckStyleParser() {
     ...
     */
    public CSSLintCheckStyleParser(final String defaultEncoding) {
    ...
    public Collection<FileAnnotation> parse(final InputStream file, final String moduleName) throws InvocationTargetException {
        try {
            ...
            digester.setClassLoader(CSSLintCheckStyleParser.class.getClassLoader());
